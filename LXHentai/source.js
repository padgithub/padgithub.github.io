...
const DOMAIN = 'https://lxmanga.life/';
const method = 'GET';
    ...
    getMangaDetails(mangaId) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return createManga({
                ...
                image: 'https://lxmanga.life/' + $('.col-md-8 > .row > .col-md-4 > img').attr('src'),
                status: status,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const obj of $("#listChuong > ul > .row:not(:first-child) > div.col-5").toArray().reverse()) {
                ...
                chapters.push(createChapter({
                    id: 'https://lxmanga.life/' + $('a', obj).attr('href'),
                    chapNum: i,
                    name: $('a', obj).text(),
                    mangaId: mangaId,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let manga of $('div.col-md-3', '.main .col-md-8 > .row').toArray().splice(0, 15)) {
                ...
                newUpdatedItems.push(createMangaTile({
                    id: 'https://lxmanga.life/' + id,
                    image: 'https://lxmanga.life/' + bg,
    ...
    getSearchTags() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const tag of $('.col-sm-3 a', '#showTheLoai').toArray()) {
                ...
                const id = (_a = 'https://lxmanga.life/' + $(tag).attr('href')) !== null && _a !== void 0 ? _a : label;
                if (!id || !label)
                    continue;
